...
public class PlaneByPointsBuilderTest {

    private final PlaneByPointsBuilder planeByPointsBuilder = PlaneByPointsBuilder.getInstance();
    ...
    public void testCreatePlaneFromThreePoints(Point point1, Point point2, Point point3, Plane expected) {
        Plane plane = planeByPointsBuilder.createPlaneFromThreePoints(point1, point2, point3);
    ...
    public void testConstructedException(Point point1, Point point2, Point point3) {
        planeByPointsBuilder.createPlaneFromThreePoints(point1, point2, point3);
    }
    ...
    public void testNormalizeCoefficients() {
        ...
        Assert.assertEquals(planeByPointsBuilder.normalizeCoefficients(oldPlane), oldPlane);
    }

    @Test
    public void testNormalizeCoefficients2() {
        Plane oldPlane = Plane.of(-60, -24, -79.2, 158.4);
        Assert.assertEquals(planeByPointsBuilder.normalizeCoefficients(oldPlane), Plane.of(25, 10, 33, -66));
    }

    @Test(expectedExceptions = ArgumentNullException.class)
    public void testNormalizeCoefficientsNullArgument() {
        planeByPointsBuilder.normalizeCoefficients(null);
    }
}